        ...
        <div className="flex flex-wrap items-start justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            <div className="cr-card p-3 text-center">
              <span className="text-[10px] uppercase font-bold text-[var(--cr-text-secondary)] block">Total Opportunities</span>
            ...
            <div className="cr-card p-3 text-center border-[var(--cr-status-green-border)]">
              <span className="text-[10px] uppercase font-bold text-[var(--cr-status-green)] block">Blocks Avoided</span>
          ...
          return (
            ...
            >
              <div>
                ...
                <h3 className="text-sm font-bold text-[var(--cr-text-primary)] mb-2">{opp.section_name}</h3>
                ...
                <div className="flex items-center gap-4 bg-[var(--cr-surface-subtle)] p-2.5 rounded-lg border border-[var(--cr-border-subtle)] mb-3">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <span className="text-[10px] uppercase font-bold text-[var(--cr-text-secondary)] block leading-none">Shared Window</span>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <span className="text-[10px] uppercase font-bold text-[var(--cr-text-secondary)] block leading-none">Synergy</span>
                ...
                <div className="flex flex-wrap gap-1.5 mb-3">
                  {opp.departments.map((dept, i) => (
                    <span
                      key={i}
                      className="cr-badge-neutral text-[10.5px] py-0.5"
                    >
                ...
                {/* Summary */}
                <p className="text-xs text-[var(--cr-text-secondary)] leading-relaxed mb-3">
                  {opp.summary}
                </p>

                {/* Expandable Power Invariant & Feasibility Check */}
                {isExpanded && (
                  <div className="mt-3 p-3 bg-[var(--cr-surface-subtle)] rounded-lg border border-[var(--cr-border)] space-y-2 text-xs text-[var(--cr-text-secondary)] text-[11px]">
              ...
              <div className="pt-3 mt-3 border-t border-[var(--cr-border-subtle)] flex items-center justify-between text-xs">
                <div className="flex items-center gap-1.5 text-[var(--cr-status-green)] font-semibold">
                  ...
                  <span className="text-[11px]">Verified Compatible</span>
                </div>
