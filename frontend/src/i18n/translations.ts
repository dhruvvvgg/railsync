...
export const TRANSLATIONS = {
  en: {
    ...
    conflictDetected: 'Manual Booking Collision: Overnight train path intersects track closure window here!',
  ...
  hi: {
    ...
    conflictDetected: 'टकराव: रात की ट्रेन का समय ट्रैक मेंटेनेंस ब्लॉक से सीधे टकरा रहा है!',
